...
def browns_pA():
    ...
    product0 = simplify(etamatrix0*gammamatrix0*etamatrixinv0*gammamatrixinv0)
    print "brown60 = " + matrix_to_mathematica(product0)
    ...
    product2 = simplify(etamatrix2*gammamatrix2*etamatrixinv2*gammamatrixinv2)
    print "brown62 = " + matrix_to_mathematica(product2)
    ...
    product4 = simplify(etamatrix4*gammamatrix4*etamatrixinv4*gammamatrixinv4)
    print "brown64 = " + matrix_to_mathematica(product4)
